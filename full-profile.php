...
// Fetching room number from allocation table for the given email ID (assuming regno is common between r and allocation tables)
$query = "SELECT r.firstName, r.middleName, r.lastName, r.regno, r.contactno, a.room_id, r.seater, 
r.stayfrom , r.emailid,r.gender,r.course,r.egycontactno,r.guardianName ,r.guardianRelation ,
r.guardianContactno ,r.corresAddress ,r.corresCIty,r.corresPincode ,r.corresState ,r.pmntAddress,
r.pmntCity ,r.pmntPincode,r.pmnatetState,r.postingDate
          FROM registration r 
          LEFT JOIN allocation a ON r.regno = a.regno 
          WHERE r.emailid = '$id'";
			...
			<tr>
			  <td colspan="2"  class="font1"><table width="100%" border="0">
                <tr>
                  ...
                  <td class="comb-value1"><span class="comb-value"><?php echo $row['room_id'] ? $row['room_id'] : 'Not Allocated'; ?></span></td>
                    </tr>
