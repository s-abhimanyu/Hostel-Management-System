...
$stmt->execute();
echo"<script>alert(' Request Succssfully Sent ');</script>";
}
?>
...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: red" align="left">Request Has Been Done !!</h3>
				<?php }
				else{
							echo "";
							}			
...
<div class="col-sm-8">
<select name="room" id="room"class="form-control"  onChange="getSeater(this.value);" onBlur="checkAvailability()" readonly> 
...
function isValidIndianNumber(number) {
    ...
    return indianNumber.test(number);
}
